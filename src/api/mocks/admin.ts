...
export const ADMIN_SEED_DATA: AdminState = {
  ...
  bookings: [
    ...
    {
      id: 'book-3',
      clientName: 'Ani Hakobyan',
      email: 'ani.hakobyan@example.com',
      eventDate: '2025-11-08',
      serviceType: 'Full Wedding Package',
      status: 'pending',
      createdAt: '2025-05-18T09:45:00.000Z',
    },
    {
      id: 'book-4',
      ...
      serviceType: 'Destination Events',
      status: 'confirmed',
    ...
    },
    {
      ...
      serviceType: 'Day-Of Coordination',
      status: 'pending',
      createdAt: '2025-06-01T11:00:00.000Z',
    },
    {
      id: 'book-6',
      clientName: 'Elena Grigoryan',
      email: 'elena.grigoryan@example.com',
      eventDate: '2025-08-30',
      serviceType: 'Private Celebrations',
      status: 'confirmed',
      createdAt: '2025-06-04T13:30:00.000Z',
    },
    {
      id: 'book-7',
      ...
      serviceType: 'Consultation',
      status: 'cancelled',
      createdAt: '2025-06-07T08:15:00.000Z',
    },
    {
      id: 'book-8',
      clientName: 'Narine Sargsyan',
      email: 'narine.sargsyan@example.com',
      eventDate: '2025-07-26',
      serviceType: 'Wedding Planning',
      status: 'confirmed',
      createdAt: '2025-06-09T15:50:00.000Z',
    },
    {
      id: 'book-9',
      ...
      serviceType: 'Full Wedding Package',
      status: 'pending',
      createdAt: '2025-06-10T10:05:00.000Z',
    },
    {
      id: 'book-10',
      clientName: 'Armen Vardanyan',
      email: 'armen.vardanyan@example.com',
      eventDate: '2025-09-28',
      serviceType: 'Private Celebrations',
      status: 'pending',
      createdAt: '2025-06-10T12:40:00.000Z',
    },
  ],
  codeTable: [
    {
  ...
  profile: {
    ...
    avatarUrl: '/images/about/hero.webp',
    bio: 'Managing content and bookings for Dream & Celebrate.',
  },
};
